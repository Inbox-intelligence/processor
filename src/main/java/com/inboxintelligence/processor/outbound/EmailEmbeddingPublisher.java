...
import static com.inboxintelligence.persistence.model.enums.ProcessedStatus.PUBLISHED_FOR_EMBEDDING;
...
public class EmailEmbeddingPublisher {
    ...
    public void publishEmbeddingEvent(EmailContent emailContent) {
        ...
        emailContent.setProcessedStatus(PUBLISHED_FOR_EMBEDDING);
